...
export const Row2Col1a = (props) => {
  ...
  return (
    <div id="skilltotals" style={{width:col1a+'px',minWidth:col1a+'px',height:(row2Orig)+'px',maxHeight:(row2Orig)+'px',overflowY:'scroll',overflowY:'hidden',boxSizing:'border-box'}}>
